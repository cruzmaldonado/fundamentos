...
const nombres = ['Wladimir', 'Pablo', 'Andres', 'Carlos', 'Juan', 'Wladimir', 'Pablo', 'Andres', 'Carlos']

// 5. crea una funcion que reciba un arreglo de números y devuelva un nuevo arreglo con la suma de los arreglos.
